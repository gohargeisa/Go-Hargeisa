 ...
 * click fetches the next page from /api/products (see
 * getProductsPageForListing) instead of slicing an already-fully-loaded
 * in-memory list, so the initial page load only ever ships the first
 * `PAGE_SIZE` dishes' data, not this menu's full ~60-item catalog. Images
